const p=Math.PI/180,v=1.1,se=1024,O=64,G=48,Ae=.4,we=new Set(["day_2048.jpg","bluemarble_1024.jpg","night_2048.jpg","clouds_1024.png","specular_1024.jpg"]),le={day:["day_2048.jpg","bluemarble_1024.jpg"],night:["night_2048.jpg"],clouds:["clouds_1024.png"],spec:["specular_1024.jpg"]},y={day:null,night:null,clouds:null,spec:null};let ue=!1,k=!1;function Te(){if(ue)return;ue=!0;const t=new URL("../../assets/earth/",import.meta.url).href;for(const a of Object.keys(le))le[a].filter(s=>we.has(s)).forEach((s,o)=>{const r=new Image;r.decoding="async";const i=()=>{const h=y[a];h&&h.rank<o||(y[a]={img:r,rank:o,name:s,w:r.naturalWidth,h:r.naturalHeight,dirty:!0},k=!0)};r.onload=()=>{r.decode?r.decode().then(i,i):i()},r.onerror=()=>{},r.src=t+s})}let _=null,e=null,q=!1,I=!1,z=!1,X=null,ce=1,he=null,fe=null,de=null,D=null,V=null,K=null;const m={},x={size:[0,0],msLast:0,msAvg:0,renders:0,skipped:0,gl:null,tex:{}},_e=`
